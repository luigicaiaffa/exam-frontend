            ...
            <div className="card-body">
              ...
              <ul className="list-group list-group-flush">
                <li className="list-group-item">
                  ...
                  <div className="fw-semibold ms-2">- {guest.username}</div>
                </li>
                <li className="list-group-item">
                  <span className="card-subtitle text-secondary">
                    Corso di Laurea
                  </span>
                  <div className="fw-semibold ms-2">- {guest.degreeCourse}</div>
                </li>
                <li className="list-group-item">
                  <span className="card-subtitle text-secondary">
                    Totale CFU
                  ...
                  {averages.totalCfu == 0 ? (
                    <div className="fw-semibold ms-2">- {guest.totalCfu}</div>
                  ) : (
                        ...
                        return (
                          ...
                          >
                            <div className="d-flex justify-content-between align-items-center">
                              <Link
                                to={
                                  "/courses/" + getCourseFromExam(exam.id)?.id
                                }
                                className=" w-100"
                              >
                                <div>
