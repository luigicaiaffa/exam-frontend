  ...
  return (
    <>
      <div className="d-flex justify-content-between align-items-center mt-5 mb-3">
        ...
        <div>
          <Link className="btn btn-sm btn-dark disabled" to="/courses">
      ...
      <div className="row row-cols-1 row-cols-md-2 row-cols-xl-3 g-4 mb-5">
        {guest.courses && guest.courses.lenght !== 0 ? (
          guest.courses.sort((a, b) => b.courseYear - a.courseYear).sort((a, b) => a.isPassed - b.isPassed).map((course) => {
            return (
                                    ...
                                    >
                                      <div>
                                        ...
                                        {!exam.grade && !exam.isCancelled && (
                                          <div>
                                            <Link className="badge bg-warning addVote">
